...
export const Messages = "Communication";
export const Cart = "Cart";
export const Checkout = "Check out";
export const Pinned = "Pinned";
export const SearchCrocs = "Search";
...
// Color Modes
export const LightModeText = "Light mode";
...
export const RegistrationPlanText="View Full Details of All Registration Plans";
...
export const PrivateCChat = "Private Classified Chat";
export const MarketplaceChat = "Marketplace Classified Chat";
export const ApplicationChat = "Applications Classified Chat";
export const ThreadList = "Thread List";
export const StartChat = "Start a Classified Chat";
export const ForumSingle = "Forum Single";
export const ForumDetail = "Forum Detail";


//Manage Store
export const ManageStore = "Manage Store";
export const ProductServiceList = "Product and Service List";
export const AddProductServiceList = "Add a Product or Service List";
...
export const AgreeToTermsAndConditions = "I agree with the processing of personal data ";
export const TermsAndConditions = "Terms and Conditions";
export const AlreadhaveAccount = "Already have an account?"
...
export const AddNewAddress = "Add a New Address";
...
export const AccountCountry = "Account Country";
...
export const IntercomCode = "Intercom Code (Optional)";
...
export const RegistrationPlan = 'Registration Plan';
export const MyRegistrationPlans = 'My Registration Plan';
...
export const PlzEnterEmail = "Please enter email";
...
export const SearchWithinPage = `Search within the Page`;
export const SearchResultsWithin = "Search Results";
...
export const SignUpToAccount = `Create an Account`;
...
// 1 webbb constants
export const Parent1Web = "1Webbb";
export const MediaCap = "Media";
export const ContestsTitle = "Contests";
export const MarketplaceText = "Marketplace";
export const EventAndActivites = "Event And Activites";
...
export const JobDesiredHeading = "Desired Job Titles/Positions";
...
export const BirthdateProof = "Birth Date Proof";
...
export const ShippingAddress = "Shipping Addresses";
...
export const ApartmentBuilding = "Apartment, House no., Building";
export const AreaStreetVillage = "Area, Street, Sector, Village";
...
export const ColorsLayouts = "Colors and Layouts";
export const PreviewSettings = "PREVIEW SETTINGS";
export const Layout_Type = "Layout Direction";
export const Sidebar_Icon = "Navigation Menu Icons";
export const UnlimitedColor = "Color Picker";
export const Mix_Layout = "MixLayout";
export const Sidebar_Type = "Navigation Menu";
...
export const BirhtdayInformation= "Birthday Information";
export const PersonalInformation = "Personal Information";
export const Birhtdate="Birth Date";
export const GuardianName ="Guardian's Username";
export const GuardianEmail ="Guardian's Email";
export const MyResumeses ="My Resumes";
export const ResumeDetails ="Resume Details";
export const SkillNExperience ="Skill and Experience";
export const ResumeType ="Resume Type";
export const AddResume="Add a Resume";
export const ResumeName = "Resume Name";
export const SRNO="S.No.";
export const DefaultPublicResume = "Default Public Resume";
export const Type = "Type";
export const Subcategories = "Subcategories";
export const Actions = "Actions";
export const Idownloaded = "I Downloaded";
export const WorkExperience = "Work Experience";
export const Training = "Training";
export const Skill = "Skill";
export const AccountSettings = "Account Settings";
export const AdditionalServices = "Additional Services";
export const PlanDetails = "Plan Details";
export const PlanSummary = "Plan Summary";
export const MyCurrentPlan = "My Current Plan Details";
export const OthersPlan = "Other Plans";

//brand tools
export const BrandTools = "Brand Support Tools";
export const ManageExternalTitle = "Manage External Links";
export const KnowledgeSystems = "Knowledge System";
export const PhotoContestSystem = "Photo Contest System ";
export const ManageQuizSurveySystem = "Manage Quiz and Survey System";
export const QuizMaterial = "Manage Quiz Material";
export const ManageAttendanceSystem = "Manage Attendance System";
export const AddAttendanceNewEvent = " Add New Activity";
export const ManageAttendance = "Manage Attendance System";
export const ManageAttendanceActivityEdit = "Edit Attendance Activity";

// Manage Branches
export const ManageOnlineStoreTitle = "Manage Online Store";
export const ManageBranches = "Manage Branches";
export const ManagesBranchesAdd = "Add a Branch"; 
export const AddNewBranchPublicContact = "Add a Branch Public Contact";
export const AddSchedules = "Add Branch Scheduling";
export const NewAddonCategory = "Add an Addon Category";
export const AddonCategory = "Addon Category";
export const AddCouponTitle = "Add a Coupon";
export const DeliveryFeesTitle = "Add Delivery Fees";
export const DeliveryWorkersTitle = "Add a Delivery Worker";
export const SchedulesTitle = "Add Scheduling";
export const WhatsappNoList = "Whatsapp No List";
export const ContactNoList = "Contact No List";
export const EmailList = "Email List";
export const ReferralText = "Welcome to your referral panel. Share your link and earn (5)% for each first transaction from your Successful Referrals (complete subscription or purchase)";
export const ReferralTextB = "You will earn (5)% for each transaction from your Successful Referrals";
export const ReferralTextC = "Your referral link is :"


//Brand Support Tools
export const BrandSupportTools = "Brand Support Tools";
export const AddMangeExternalLinks = "Add an External Link";
export const AddPhotoCotest = "Add a Photo Contest";
export const AddStudyMaterialAndLesson = "Add a Lesson";
export const AddAQuizMaterial = "Add a Quizz Material";
export const AddQuestion = "Add a Question";
export const AddSurveyQuizzes = "Add a Survey or Quiz";
export const AddSpecialParameter = "Add Special Parameters";
export const Lesson = "Lessons";
export const SpecialParameter = "Manage Special Parameter";


//Manage Contents
export const ManageContents = "Manage Contents";
export const ManageAlbums = "Manage Albums";
export const ManageCoupons = "Manage Coupons";
export const DeliveryWorker = "Delivery Workers";
export const DeliveryFee = "Delivery Fees";
export const ManageMyCollection = "Manage My Collections";
export const AddNewAlbums = "Add an Album";
export const ManageUploadedContents = "Manage Uploaded Contents";
export const AddNewIdeaStoryAlbum = "Add a new idea/ story/ album";
export const AttributionRequired = 'Attribution Required';
export const DropZoneWarning = "Pending contents: Admin's approval is required for each of your uploaded contents, before displaying it to other users. Check your Media Profile >> “Pending Photos” page.";
export const StartNewUpload = 'Start New Upload';
export const UndoChanges = 'Undo Changes';
export const AssignContenttoProductService = 'Assign Contents to a Product or Service';
export const SelectPhotoContest = 'Select a Photo Contest';
...
export const JobOpnings = "job Opnings";

//Cominication
export const CommunicationTitle = "Communication";
export const StartIChatTitle = " Start C-Chat";

//User
export const MinWithdrawlText = "The minimum amount for withdrawals";


//Renew 
export const RenewAccount = "Renew Account";
export const SelectAction = "Select an Action";
export const Renew = "Renew";
export const CurrentPlanSummery = "Current Plan Summery";
export const NewBillingDate = "New Billing Date";
export const NewBiilingDateText = "The new billing date will be applied for the plan itself, and for any addtional services you select.";


// Validation Constant 
export const RequiredFieldValidationText = "Required";
export const EmailFieldValidationText = "Invalid email format";
export const URLFieldValidationText = "Invalid URL format";
export const PhoneNumberFieldValidationText = "Invalid phone number format";
export const DateFieldValidationText = "Invalid date format";
export const NumbersFieldValidationText = "Only whole numbers";
export const DecimalFieldValidationText = "Only decimal amount value";
