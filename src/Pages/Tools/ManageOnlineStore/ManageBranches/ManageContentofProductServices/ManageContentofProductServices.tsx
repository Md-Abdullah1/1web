...
import { ContentProductServicesColumnData, supportTicketData } from '../../../../../Data/Tools/BrandSupportTools/ButtonActions'
import {    ManageOnlineStore, ManageProductServicesAction } from '../../../../../Data/Tools/ManageContents/ManageContentButtons'

const ManageContentofProductServices = () => {
    const [toggleDelete, setToggleDelete] = useState(false);
    const [data, setData] = useState(supportTicketData); 
    const handleRowSelected =() =>{}
    return (
    <div className='page-body'>
      <Breadcrumbs mainTitle={`Contents of Products and Services`} parent={`Manage Store`} />
      <Container fluid>
        <Row>
          <Col sm="12">
            <Card>
              ...
              <CardBody>
                ...
                <div className=''>
                    ...
                    <DataTable className='custom-scrollbar' columns={ContentProductServicesColumnData} data={data} striped={true} pagination selectableRows onSelectedRowsChange={handleRowSelected} clearSelectedRows={toggleDelete} />
                </div>
                </>
              </CardBody>
            </Card>
...
export default ManageContentofProductServices