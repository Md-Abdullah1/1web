...
import ContestModal from "../MyMediaCenter/PhotoContestsData/ContestModal";
import { Carousel } from "react-responsive-carousel";
import GalleryFilter from "../MyMediaCenter/Photos/GalleryFilter";
    ...
    <GalleryFilter/>
        <div className={`product-wrapper-grid `}>
            <Row>
                ...
                {openModal && <ContestModal value={openModal} setOpenModal={setOpenModal} dataId={dataId} />}
            </Row>
        </div>
    </CardBody>
  );
