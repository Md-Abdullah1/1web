...
import { AddNewIdeaStoryAlbum, AssignContenttoProductService, AttributionRequired, DropZoneWarning, StartNewUpload, UndoChanges } from '../../../utils/Constant'
...
const ProductServiceSaleContent = () => {
    ...
    return (
        <div className="px-4 py-4">   
            ...
            <Popup title={`Add Product`} openModalToggle={()=>setOpenPSModal(!openPSModal)} isOpen={openPSModal} size={`xl`} backdrop={true} isClose={false}>
                <div className='p-3'>
                        {/* <Formik
...
export default ProductServiceSaleContent