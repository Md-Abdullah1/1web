...
import { H1, H4, Image, LI, P, UL } from "../../../../AbstractElements";
...
import CouponModal from "../../CouponsData/CouponModal";
    ...
    <Card>
        ...
        <div className={`product-wrapper-grid `}>
            <Row>
                ...
                {openModal && <CouponModal value={openModal} setOpenModal={setOpenModal} dataId={dataId} />}
            </Row>
        </div>
        </CardBody>
    </Card>
