...
import QuizzSurveyModal from './QuizzSurveyModal';
    ...
    <Card>
        ...
        <Row>
            {items.map((item, index) =>{
              ...
              {openModal && <QuizzSurveyModal value={openModal} setOpenModal={setOpenModal} dataId={dataId} />}
          </Row>
        </CardBody>
    </Card>
  )
...
export default QuizzesAndSurverysData