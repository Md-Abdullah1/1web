...
export interface PendingPhotosModalInterface {
    value: boolean;
    setOpenModal: (value: boolean) => void;
    dataId: undefined | number;
}
const PendingPhotosModal = ({value , setOpenModal , dataId}:PendingPhotosModalInterface) => {
...
export default PendingPhotosModal