...
import PendingPhotosModal from "./PendingPhotosModal";
    ...
    <Card>
        ...
        <CardBody className='pt-2'>
            <Row>
              ...
              {openModal && <PendingPhotosModal value={openModal} setOpenModal={setOpenModal} dataId={dataId} />}
          </Row> 
        </CardBody>
    </Card>
...
export default PendingPhotosData