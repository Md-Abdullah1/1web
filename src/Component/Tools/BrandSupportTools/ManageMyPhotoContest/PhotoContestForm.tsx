    ...
    <Form className="form-wizard">
      ...
      <Row>
        <Col sm="4" className="mb-3">
          ...
          />
          <TextCounter
            length={values?.photoContestTitle?.length}
            totalLength="140"
          />
          <ErrorMessage
            name="photoContestTitle"
        ...
        <Col sm="4" className="mb-3">
          ...
          />
          <TextCounter length={values?.description?.length} totalLength="140" />
          <ErrorMessage
            name="description"
            component="span"
            className="invalid-feedback"
                ...
                >
                  <Row>
                    ...
                    <Col md={2} className="mb-3">
                      {priceFormCount.length.toString() !== '1' && (
                        <span
